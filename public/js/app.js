...
function updateCart(zip) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/update-cart", zip).then(function (res) {
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(); // init admin code is herwer:
